      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white">
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <LanguageSwitcher />
            <a href="#signup">
              <Button className="bg-yellow-500 hover:bg-yellow-600 text-white">{t("signup.button")}</Button>
            </a>
          </div>
        </div>
      </header>
      <main className="flex-1">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <h3 className="font-bold text-yellow-500 text-2xl mb-1">$25K</h3>
                    <p className="text-gray-500 text-sm">{t("about.stats.funding")}</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <h3 className="font-bold text-yellow-500 text-2xl mb-1">12</h3>
                    <p className="text-gray-500 text-sm">{t("about.stats.teams")}</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <h3 className="font-bold text-yellow-500 text-2xl mb-1">6 mo</h3>
                    <p className="text-gray-500 text-sm">{t("about.stats.duration")}</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <h3 className="font-bold text-yellow-500 text-2xl mb-1">85%</h3>
        ...
        <section id="legal" className="py-20 bg-yellow-50">
          <div className="container px-4 md:px-6">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-yellow-200 mb-10">
        ...
        {/* Sign Up Section */}
        <section id="signup" className="py-20 bg-yellow-500">
          <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="#process" className="text-gray-400 hover:text-yellow-500 text-sm">
                    {t("nav.process")}
                  </Link>
                </li>
                <li>
                  <Link href="#about" className="text-gray-400 hover:text-yellow-500 text-sm">
                    {t("nav.about")}
                  </Link>
                </li>
                <li>
